...
def solar_yesterday_power_chart_value(n_intervals):
    ...
    weather_data1.loc[weather_data1['SolarIrradiance (W/m2)'] == 0, ['Wind (km/h)', 'UVIndex', 'CloudCover (%)']] = 0
    ...
    yes_independent_columns1 = yes_df1[['SolarIrradiance (W/m2)', 'Wind (km/h)', 'UVIndex', 'CloudCover (%)']][
                               0:yes_count_total_rows]
