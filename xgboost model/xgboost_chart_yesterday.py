...
weather_data1.loc[weather_data1['SolarIrradiance (W/m2)'] == 0, ['Temp (°C)', 'RealFeelTemp (°C)', 'DewPoint (°C)', 'Hum (%)']] = 0
...
filter_weather_yes_values = weather_data1[
    ...
    ['SolarIrradiance (W/m2)', 'Temp (°C)', 'RealFeelTemp (°C)', 'DewPoint (°C)', 'Hum (%)']]
...
yes_independent_columns = yes_df1[['SolarIrradiance (W/m2)', 'Temp (°C)', 'RealFeelTemp (°C)', 'DewPoint (°C)', 'Hum (%)']][
                          0:yes_count_total_rows]
yes_independent_columns1 = yes_df1[['SolarIrradiance (W/m2)', 'Temp (°C)', 'RealFeelTemp (°C)', 'DewPoint (°C)', 'Hum (%)']][
                           0:yes_count_total_rows]
