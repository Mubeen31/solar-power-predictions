...
with open("daily_weather_forecasted_data.csv", "a", newline = '\n') as f:
    ...
    writer.writerow([dte_0, solar_irradiance_0, temp_max_0, weather_status_0, cloud_cover_0])
    writer.writerow([dte_1, solar_irradiance_1, temp_max_1, weather_status_1, cloud_cover_1])
    writer.writerow([dte_2, solar_irradiance_2, temp_max_2, weather_status_2, cloud_cover_2])
    writer.writerow([dte_3, solar_irradiance_3, temp_max_3, weather_status_3, cloud_cover_3])
    writer.writerow([dte_4, solar_irradiance_4, temp_max_4, weather_status_4, cloud_cover_4])
